    ...
    return SafeArea(
      child: FutureBuilder<HomeSummary>(
        ...
        builder: (context, snap) {
          ...
          if (snap.hasError) {
            return Center(
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                ...
                FilledButton(
                  onPressed: () =>
                      setState(() => _summary = _api.fetchHomeSummary()),
          ...
          final remainingDays = s.cycle?.endAt == null
              ? '-'
              : (s.cycle!.endAt!.difference(now).inDays + 1)
                  .clamp(0, 999)
                  .toString();
          ...
          return ListView(
            ...
            children: [
              ...
              Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Text('이번 주 사용 한도',
                            style: TextStyle(color: Colors.white70)),
                        const SizedBox(height: 4),
                        Text(won(s.weeklyLimit),
                            style: const TextStyle(
                                fontSize: 34,
                                color: Colors.white,
              ...
              Row(children: [
                stat('이번 주 사용', won(s.weeklySpent)),
                const SizedBox(width: 8),
                stat('계좌 잔액', won(s.livingAccountBalance))
              ]),
              const SizedBox(height: 8),
              Card(
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      _Mini('월 예산',
                          (s.monthlyBudget / 10000).toStringAsFixed(0), '만원'),
                      _Mini('이번주 지출',
                          (s.weeklySpent / 10000).toStringAsFixed(1), '만원'),
                      _Mini('남은일', remainingDays, '일'),
                      const _Mini('미분류', '-', '건'),
                    ],
                  ),
                ),
